...
ui <- fluidPage(
  titlePanel("RioSlide"),
  div(style = "text-align: center;", img(src = "Proj_partners.png", height = "100px")),  
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      absolutePanel(bottom = 750, left = 10, # Adjust position as needed
            ...
            h3("Data Protection and Map Usage Disclaimer"),
            p("This map's zoom level is controled to balance detail with data protection. 
      ...
      contact the appropriate authority.", a(href = "https://www.rio.rj.gov.br/web/georio/quem-somos", target="_blank", strong("Source: GeoRIO"))),
            ...
            a(href="https://munizlimap15.github.io/Pedrolima/", target="_blank", "Pedro Lima")),
